export const SNEAKER_CATALOG: Record<string, Record<string, string[]>> = {
  ...
  "On": {
    "Cloud 5": ["All Black", "White", "Midnight", "Glacier"],
    "Cloudmonster": ["All Black", "Frost", "Acai"],
    "Cloudsurfer": ["Black", "Creek"],
    "Cloudnova": ["Black", "White"]
  },
  "Salomon": {
    "XT-6": ["Black", "White", "Lunar Rock", "Vanilla Ice", "Monument"],
    "XT-4": ["Black", "Fiery Red", "White"],
    "ACS Pro": ["Black", "Metal", "Vanilla Ice"],
    "Speedcross 6": ["Black", "White"]
  },
  "New Balance": {
  ...
  "adidas": {
    "Samba OG": ["Black", "White", "Sporty & Rich"],
    "Gazelle": ["Black", "Navy", "Indoor"],
...
export const SIZES = [
  "25.0cm","25.5cm","26.0cm","26.5cm","27.0cm","27.5cm","28.0cm","28.5cm","29.0cm","30.0cm"
];
